...
A colleague wrote `trainer.py` as a proof-of-concept for training a transformer model to
predict protein fitness from sequence. The code works and produces results.
